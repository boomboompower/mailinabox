...
type TenantQuery struct {
	...
	withWebDomains       *WebDomainQuery
	withDNSRecords       *DNSRecordQuery
	withDNSZoneProviders *DNSZoneProviderQuery
...
func (_q *TenantQuery) QueryAliases() *AliasQuery {
	query := (&AliasClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryWebDomains chains the current query on the "web_domains" edge.
func (_q *TenantQuery) QueryWebDomains() *WebDomainQuery {
...
// QueryDNSRecords chains the current query on the "dns_records" edge.
func (_q *TenantQuery) QueryDNSRecords() *DNSRecordQuery {
	query := (&DNSRecordClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryDNSZoneProviders chains the current query on the "dns_zone_providers" edge.
func (_q *TenantQuery) QueryDNSZoneProviders() *DNSZoneProviderQuery {
	query := (&DNSZoneProviderClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *TenantQuery) Clone() *TenantQuery {
	...
	return &TenantQuery{
		...
		withWebDomains:       _q.withWebDomains.Clone(),
		withDNSRecords:       _q.withDNSRecords.Clone(),
		withDNSZoneProviders: _q.withDNSZoneProviders.Clone(),
...
func (_q *TenantQuery) WithAliases(opts ...func(*AliasQuery)) *TenantQuery {
	query := (&AliasClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithWebDomains tells the query-builder to eager-load the nodes that are connected to
// the "web_domains" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *TenantQuery) WithWebDomains(opts ...func(*WebDomainQuery)) *TenantQuery {
	query := (&WebDomainClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withWebDomains = query
	return _q
}

// WithDNSRecords tells the query-builder to eager-load the nodes that are connected to
// the "dns_records" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *TenantQuery) WithDNSRecords(opts ...func(*DNSRecordQuery)) *TenantQuery {
	query := (&DNSRecordClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withDNSRecords = query
	return _q
}

// WithDNSZoneProviders tells the query-builder to eager-load the nodes that are connected to
// the "dns_zone_providers" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *TenantQuery) WithDNSZoneProviders(opts ...func(*DNSZoneProviderQuery)) *TenantQuery {
	query := (&DNSZoneProviderClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withDNSZoneProviders = query
	return _q
}
...
func (_q *TenantQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tenant, error) {
	var (
		...
		loadedTypes = [5]bool{
			_q.withUsers != nil,
			_q.withAliases != nil,
			_q.withWebDomains != nil,
			_q.withDNSRecords != nil,
			_q.withDNSZoneProviders != nil,
		}
	)
	...
	if query := _q.withAliases; query != nil {
		if err := _q.loadAliases(ctx, query, nodes,
			func(n *Tenant) { n.Edges.Aliases = []*Alias{} },
			func(n *Tenant, e *Alias) { n.Edges.Aliases = append(n.Edges.Aliases, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withWebDomains; query != nil {
		if err := _q.loadWebDomains(ctx, query, nodes,
			func(n *Tenant) { n.Edges.WebDomains = []*WebDomain{} },
			func(n *Tenant, e *WebDomain) { n.Edges.WebDomains = append(n.Edges.WebDomains, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withDNSRecords; query != nil {
		if err := _q.loadDNSRecords(ctx, query, nodes,
			func(n *Tenant) { n.Edges.DNSRecords = []*DNSRecord{} },
			func(n *Tenant, e *DNSRecord) { n.Edges.DNSRecords = append(n.Edges.DNSRecords, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withDNSZoneProviders; query != nil {
		if err := _q.loadDNSZoneProviders(ctx, query, nodes,
			func(n *Tenant) { n.Edges.DNSZoneProviders = []*DNSZoneProvider{} },
			func(n *Tenant, e *DNSZoneProvider) { n.Edges.DNSZoneProviders = append(n.Edges.DNSZoneProviders, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TenantQuery) loadAliases(ctx context.Context, query *AliasQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *Alias)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Tenant)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Alias(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenant.AliasesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.tenant_aliases
		if fk == nil {
			return fmt.Errorf(`foreign-key "tenant_aliases" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "tenant_aliases" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *TenantQuery) loadWebDomains(ctx context.Context, query *WebDomainQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *WebDomain)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Tenant)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.WebDomain(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenant.WebDomainsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.tenant_web_domains
		if fk == nil {
			return fmt.Errorf(`foreign-key "tenant_web_domains" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "tenant_web_domains" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *TenantQuery) loadDNSRecords(ctx context.Context, query *DNSRecordQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *DNSRecord)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Tenant)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.DNSRecord(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenant.DNSRecordsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.tenant_dns_records
		if fk == nil {
			return fmt.Errorf(`foreign-key "tenant_dns_records" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "tenant_dns_records" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *TenantQuery) loadDNSZoneProviders(ctx context.Context, query *DNSZoneProviderQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *DNSZoneProvider)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Tenant)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.DNSZoneProvider(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenant.DNSZoneProvidersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.tenant_dns_zone_providers
		if fk == nil {
			return fmt.Errorf(`foreign-key "tenant_dns_zone_providers" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "tenant_dns_zone_providers" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
