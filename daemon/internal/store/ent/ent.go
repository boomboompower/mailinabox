...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			authfailure.Table:        authfailure.ValidColumn,
			backuprun.Table:          backuprun.ValidColumn,
			checkresult.Table:        checkresult.ValidColumn,
			counter.Table:            counter.ValidColumn,
			dnsrecord.Table:          dnsrecord.ValidColumn,
			dnszoneprovider.Table:    dnszoneprovider.ValidColumn,
			encryptionsetup.Table:    encryptionsetup.ValidColumn,
			lease.Table:              lease.ValidColumn,
			mailkeyslot.Table:        mailkeyslot.ValidColumn,
			metricsample.Table:       metricsample.ValidColumn,
			...
			webdomain.Table:          webdomain.ValidColumn,
			webrule.Table:            webrule.ValidColumn,
